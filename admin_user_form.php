...
$validates = array(
	...
	array('type'=>'length', 'field'=>'username', 'min'=>6, 'max'=>20, 'message'=>'Độ dài Tài khoản tối thiểu là 6, lớn nhất là 20 ký tự'),
	array('type'=>'length', 'field'=>'passwd', 'min'=>6, 'max'=>20, 'message'=>'Độ dài Mật khẩu tối thiểu là 3, lớn nhất là 20 ký tự'),
...
<form action="" method="POST">
	...
	<div class="form-row clearfix">
		...
		<div class="form-control">
			<input type="password" name="passwd" value="<?= $record->passwd ?>" class="input-md <?= $oValidator->checkError('passwd')?'invalid':'' ?>"/>
